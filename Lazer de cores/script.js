...
var Game = {
  ...
  gameOver: function(){
  	...
  	this.clear();
  	var message = "I voce perdeu kkkk";
  	var message2 = "Pontos: " + Game.score;
  	var message3 = "Clique ou pressione a barra de espaço para jogar";
  	this.pause();
  ...
  updateScore: function(){
  	...
  	this.ctx.fillText("Pontos: " + this.score, 8, 20);
